                        ...
                        <Box sx={{ display: { sm: '', md: 'none' } }}>
                            ...
                            <Drawer anchor="right" open={open} onClose={toggleDrawer(false)}>
                                <Box sx={{ minWidth: '60dvw', p: 2, backgroundColor: 'background.paper', flexGrow: 1 }}>
                                    ...
                                    <MenuItem component={Link} to="/">Homepagina</MenuItem>
                                    <MenuItem component={Link} to="/levels">Levels</MenuItem>
                                    <MenuItem component={Link} to="/forum">Forum</MenuItem>
                                    <Divider />

                                    {isAuthenticated && (
                                        <MenuItem>
                                            <Button
                                                color="primary" variant="contained" component={Link}  target="_blank" sx={{ width: '100%' }}
                                                to="/profile">
                                                Profile
                                            </Button>
                                        </MenuItem>
                                    ...
                                    {isAuthenticated && (
                                        <MenuItem>
                                            <Button
                                                color="primary" variant="outlined" component={Link}
                                                onClick={handleLogout}
                                                target="_blank"
                                                sx={{ width: '100%' }}>
                                                Logout
                                    ...
                                    {!isAuthenticated && (
                                        <MenuItem>
                                            <Button color="primary" variant="contained" component={Link} to="/register/" target="_blank" sx={{ width: '100%' }}>
                                                Registreer
                                            </Button>
                                        </MenuItem>
                                    )}
                                    ...
                                    {!isAuthenticated && (
                                        <MenuItem>
                                            <Button color="primary" variant="outlined" component={Link} to="/login" target="_blank" sx={{ width: '100%' }}>
                                                Login
                                            </Button>
                                        </MenuItem>
                                    )}
                                    {isAdmin && (
                                        <MenuItem>
                                            <Button
                                                color="primary" variant="outlined" component={Link} target="_blank" sx={{ width: '100%' }}
                                                to="/admin">
                                                Admin
                                            </Button>
                                        </MenuItem>
